package com.pes.centro_distribuicao_ms.configs.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  private final Set<String> validRolesGet = Set.of("superadmin", "adminCD");
  private final Set<String> validRolesPost = Set.of("superadmin");
  ...
  protected void doFilterInternal(HttpServletRequest request,
    ...
    if (token != null) {
      try {
        ...
        if (requestURI.equals("/v1/cds") && (method.equals("GET"))) {
            if (!validRolesGet.contains(role)) {
                throw new ResponseStatusException(FORBIDDEN);
            }
        }
        if (requestURI.equals("/v1/cds") && (method.equals("POST"))) {
